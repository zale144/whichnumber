...
type EventGamePlayerReward struct {
	GameId string `protobuf:"bytes,1,opt,name=game_id,json=gameId,proto3" json:"game_id,omitempty"`
	Player string `protobuf:"bytes,2,opt,name=player,proto3" json:"player,omitempty"`
	Amount string `protobuf:"bytes,3,opt,name=amount,proto3" json:"amount,omitempty"`
}

func (m *EventGamePlayerReward) Reset()         { *m = EventGamePlayerReward{} }
func (m *EventGamePlayerReward) String() string { return proto.CompactTextString(m) }
func (*EventGamePlayerReward) ProtoMessage()    {}
func (*EventGamePlayerReward) Descriptor() ([]byte, []int) {
	return fileDescriptor_acb596e433f7e024, []int{8}
}
func (m *EventGamePlayerReward) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventGamePlayerReward) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventGamePlayerReward.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventGamePlayerReward) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventGamePlayerReward.Merge(m, src)
}
func (m *EventGamePlayerReward) XXX_Size() int {
	return m.Size()
}
func (m *EventGamePlayerReward) XXX_DiscardUnknown() {
	xxx_messageInfo_EventGamePlayerReward.DiscardUnknown(m)
}

var xxx_messageInfo_EventGamePlayerReward proto.InternalMessageInfo

func (m *EventGamePlayerReward) GetGameId() string {
	if m != nil {
		return m.GameId
	}
	return ""
...
func (m *EventGamePlayerReward) GetPlayer() string {
	if m != nil {
		return m.Player
	}
	return ""
...
func (m *EventGamePlayerReward) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
type EventGameCreatorRefund struct {
	GameId  string `protobuf:"bytes,1,opt,name=game_id,json=gameId,proto3" json:"game_id,omitempty"`
	Creator string `protobuf:"bytes,2,opt,name=creator,proto3" json:"creator,omitempty"`
	Amount  string `protobuf:"bytes,3,opt,name=amount,proto3" json:"amount,omitempty"`
}

func (m *EventGameCreatorRefund) Reset()         { *m = EventGameCreatorRefund{} }
func (m *EventGameCreatorRefund) String() string { return proto.CompactTextString(m) }
func (*EventGameCreatorRefund) ProtoMessage()    {}
func (*EventGameCreatorRefund) Descriptor() ([]byte, []int) {
	return fileDescriptor_acb596e433f7e024, []int{9}
}
func (m *EventGameCreatorRefund) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventGameCreatorRefund) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventGameCreatorRefund.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventGameCreatorRefund) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventGameCreatorRefund.Merge(m, src)
}
func (m *EventGameCreatorRefund) XXX_Size() int {
	return m.Size()
}
func (m *EventGameCreatorRefund) XXX_DiscardUnknown() {
	xxx_messageInfo_EventGameCreatorRefund.DiscardUnknown(m)
}

var xxx_messageInfo_EventGameCreatorRefund proto.InternalMessageInfo

func (m *EventGameCreatorRefund) GetGameId() string {
	if m != nil {
		return m.GameId
	}
	return ""
...
func (m *EventGameCreatorRefund) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func (m *EventGameCreatorRefund) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
func (*EventParamsUpdated) Descriptor() ([]byte, []int) {
	return fileDescriptor_acb596e433f7e024, []int{10}
}
...
func init() {
	...
	proto.RegisterType((*EventGamePlayerReward)(nil), "zale144.whichnumber.whichnumber.EventGamePlayerReward")
	proto.RegisterType((*EventGameCreatorRefund)(nil), "zale144.whichnumber.whichnumber.EventGameCreatorRefund")
...
var fileDescriptor_acb596e433f7e024 = []byte{
	...
	,
}
...
func (m *EventGamePlayerReward) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventGamePlayerReward) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventGamePlayerReward) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventGameCreatorRefund) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventGameCreatorRefund) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventGameCreatorRefund) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventGamePlayerReward) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventGameCreatorRefund) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventGamePlayerReward) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventGamePlayerReward: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventGamePlayerReward: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *EventGameCreatorRefund) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventGameCreatorRefund: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventGameCreatorRefund: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
